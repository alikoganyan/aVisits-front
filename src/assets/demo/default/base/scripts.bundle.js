            ...
            var n = {
                offset: 110, stateId: "m-meta", init: function (t) {
                    ...
                    e(a.table).find(".m-datatable__row"), e.each(e(a.table).children(), function (t, a) {
                        ...
                        e(t).find("> thead").addClass("m-datatable__head"),
                        e(t).find("> tbody").addClass("m-datatable__body"),
                        e(t).find("> tfoot").addClass("m-datatable__foot"),
                        e(t).find("tr").addClass("m-datatable__row"),
                        e(t).find("tr > th, tr > td").addClass("m-datatable__cell"),
                        e(t).find("tr > th, tr > td").each(function (t, a) {
