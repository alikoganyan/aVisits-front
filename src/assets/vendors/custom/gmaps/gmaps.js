...
!function (e, t) {
    ...
    var t = function (e, t) {
        ...
        var o, n = Array.prototype.slice.call(arguments, 2), r = [], i = e.length;
        ...
        if (e.getBoundingClientRect) {
            var n = e.getBoundingClientRect(), r = -(window.scrollX ? window.scrollX : window.pageXOffset),
        ...
        var o = document, n = function (e) {
            ...
            var r, i = function (e, t) {
                ...
                u = e.el || e.div, d = e.markerClusterer, m = google.maps.MapTypeId[e.mapType.toUpperCase()],
                f = new google.maps.LatLng(e.lat, e.lng), y = i(e.zoomControl, !0),
                v = e.zoomControlOpt || {style: "DEFAULT", position: "TOP_LEFT"}, w = v.style || "DEFAULT",
                k = v.position || "TOP_LEFT", L = i(e.panControl, !0), b = i(e.mapTypeControl, !0),
                _ = i(e.scaleControl, !0), M = i(e.streetViewControl, !0), x = i(x, !0), C = {},
                O = {zoom: this.zoom, center: f, mapTypeId: m}, P = {
                    panControl: L,
                    zoomControl: y,
            ...
            if ("string" == typeof e.el || "string" == typeof e.div ? u.indexOf("#") > -1 ? this.el = a(u, e.context) : this.el = s.apply(this, [u, e.context]) : this.el = u, void 0 === this.el || null === this.el) throw"No element defined.";
            ...
            var T = function (e, t) {
                var o = "", n = window.context_menu[p.el.id][e];
                ...
                if (a("gmaps_context_menu")) {
                    ...
                    s.innerHTML = o;
                    var c = s.getElementsByTagName("a"), g = c.length;
                    for (r = 0; r < g; r++) {
                        var h = c[r];
                        google.maps.event.clearListeners(h, "click"), google.maps.event.addDomListenerOnce(h, "click", function (o) {
                            o.preventDefault(), n[this.id.replace(e + "_", "")].action.apply(p, [t]), p.hideContextMenu()
                        }, !1)
                    }
                    var u = l.apply(this, [p.el]), d = u[0] + t.pixel.x - 15, m = u[1] + t.pixel.y - 15;
                    s.style.left = d + "px", s.style.top = m + "px"
                }
            };
            this.buildContextMenu = function (e, t) {
                if ("marker" === e) {
                    ...
                    o.setMap(p.map), o.draw = function () {
                        var n = o.getProjection(), r = t.marker.getPosition();
            ...
            for (S = 0; S < c.length; S++) (W = c[S]) in e && z(this.map, W);
    ...
    p.prototype.createControl = function (e) {
        ...
        var o = this, n = e.details, r = e.fences, i = e.outside,
            s = {position: new google.maps.LatLng(e.lat, e.lng), map: null}, a = t(s, e);
        ...
        for (c = 0; c < h.length; c++) !function (t, o, n) {
        ...
        var t = [];
        if (void 0 === e) {
            for (n = 0; n < this.markers.length; n++) (r = this.markers[n]).setMap(null), p.fire("marker_removed", r, this);
            ...
            for (n = 0; n < e.length; n++) {
                ...
                o > -1 && ((r = this.markers[o]).setMap(null), this.markerClusterer && this.markerClusterer.removeMarker(r), p.fire("marker_removed", r, this))
            }
        ...
        var t = new google.maps.OverlayView, o = !0;
        return t.setMap(this.map), null != e.auto_show && (o = e.auto_show), t.onAdd = function () {
            ...
            for (var i = 0; i < r.length; i++) !function (e, t) {
            ...
            switch (e.verticalAlign) {
                case"top":
                    r.style.top = n.y - s + e.verticalOffset + "px";
                    break;
                default:
                case"middle":
                    r.style.top = n.y - s / 2 + e.verticalOffset + "px";
                    break;
                case"bottom":
            ...
            switch (e.horizontalAlign) {
                case"left":
                    r.style.left = n.x - a + e.horizontalOffset + "px";
                    break;
                default:
                case"center":
                    r.style.left = n.x - a / 2 + e.horizontalOffset + "px";
                    break;
                case"right":
                    r.style.left = n.x + e.horizontalOffset + "px"
            }
            r.style.display = o ? "block" : "none", o || e.show.apply(this, [r])
        }, t.onRemove = function () {
            var o = t.el;
        ...
        var t = [], o = e.path;
        if (o.length) if (void 0 === o[0][0]) t = o; else for (var n, r = 0; n = o[r]; r++) t.push(new google.maps.LatLng(n[0], n[1]));
        var i = {
            map: this.map,
            path: t,
    ...
    return p.prototype.getRoutes = function (e) {
        ...
        var o = t({avoidHighways: !1, avoidTolls: !1, optimizeWaypoints: !1, waypoints: []}, e);
        o.origin = /string/.test(typeof e.origin) ? e.origin : new google.maps.LatLng(e.origin[0], e.origin[1]), o.destination = /string/.test(typeof e.destination) ? e.destination : new google.maps.LatLng(e.destination[0], e.destination[1]), o.travelMode = c, o.unitSystem = g, delete o.callback, delete o.error;
        var n = [];
        ...
        (e = t({
            ...
            path: !1,
            samples: 256
        }, e)).locations.length > 0 && e.locations[0].length > 0 && (e.locations = n(o([e.locations], i, !1)));
        var r = e.callback;
        delete e.callback;
        ...
        o.panel = r, o = t({map: this.map}, o), n = new google.maps.DirectionsRenderer(o), this.getRoutes({
            origin: e.origin,
        ...
        if (e.origin && e.destination) this.getRoutes({
            ...
            callback: function (o) {
                if (o.length > 0 && e.start && e.start(o[o.length - 1]), o.length > 0 && e.step) {
                    var n = o[o.length - 1];
                    if (n.legs.length > 0) for (var r, i = n.legs[0].steps, s = 0; r = i[s]; s++) {
                        r.step_number = s;
                        var a = {
                            path: r.path,
                            strokeColor: e.strokeColor,
        ...
        }); else if (e.route && e.route.legs.length > 0) for (var o, n = e.route.legs[0].steps, r = 0; o = n[r]; r++) {
            o.step_number = r;
            var i = {
                path: o.path,
                strokeColor: e.strokeColor,
        ...
        if (s) for (d = 0; d < s.length; d++) {
            ...
            for (_ = 0; _ < s[d].stylers.length; _++) for (var f in s[d].stylers[_]) {
                var y = s[d].stylers[_][f];
                "hue" != f && "color" != f || (y = "0x" + y.substring(1)), m.push(f + ":" + y)
            }
            var v = m.join("|");
            "" != v && n.push("style=" + v)
        }
        if (a) {
            ...
            var L = o.path;
            if (L.join) for (var b, _ = 0; b = L[_]; _++) a.push(b.join(",")); else a.push("enc:" + L);
        ...
        if (-1 == p.custom_events.indexOf(e)) google.maps.event.trigger(t, e, Array.prototype.slice.apply(arguments).slice(2)); else if (e in o.registered_events) for (var n = o.registered_events[e], r = 0; r < n.length; r++) !function (e, t, o) {
            n[r]["handler"].apply(t, [o])
        }(0, o, t)
